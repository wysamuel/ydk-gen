...
**Ubuntu (Debian-based)** - The following packages must be present in your system before installing YDK-Py::
   ...
   $ wget http://devhub.cisco.com/artifactory/debian-ydk/0.7.1-alpha/artful/libydk_0.7.1-1_amd64.deb
...
Release Notes
--------------
The current YDK release version is 0.7.1-alpha (beta). YDK-Py is licensed under the Apache 2.0 License.
