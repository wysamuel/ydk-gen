...
class Entity {
  ...
  public:
    ...
    virtual std::map<std::string, std::shared_ptr<Entity>> get_child_containers() const = 0;
    virtual std::map<std::string, std::shared_ptr<Entity>> get_child_lists() const = 0;
    virtual std::vector<YLeaf> get_leafs() const = 0;
    virtual std::vector<YLeafList> get_leaf_lists() const = 0;
